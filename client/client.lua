...
lib.addKey('toggleRuler', {
    ...
    onPressed = function()
        ...
        if isActive then
            ...
            pointB = nil
            isPointASet = false
            lib.notify({ title = 'Ruler Activated', type = 'inform', description = 'Modo: ' .. (mode == 'static' and '2 points' or 'Follow') })
        else
...
CreateThread(function()
    ...
    while true do
        ...
        if isActive then
            ...
            if not isPointASet then
                DrawMarker(28, raycastCoord.x, raycastCoord.y, raycastCoord.z, 0, 0, 0, 0, 0, 0, 0.1, 0.1, 0.1, 255, 0, 0, 200, false, false, 0, false, nil, nil, false)
                lib.showTextUI('[E] Set Point A', { position = 'right-center' })
            elseif mode == 'static' and not pointB then
                DrawMarker(28, raycastCoord.x, raycastCoord.y, raycastCoord.z, 0, 0, 0, 0, 0, 0, 0.1, 0.1, 0.1, 0, 0, 255, 200, false, false, 0, false, nil, nil, false)
